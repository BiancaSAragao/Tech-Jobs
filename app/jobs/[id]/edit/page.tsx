...
export default function EditJobPage({ params }: { params: { id: string } }) {
  const { user } = useAuth()
  const { getJobById, updateJob, isLoading } = useJobs()
  ...
  // Redirect if not owner or job not found
  if (!user || user.type !== "employer" || !job || job.employerId !== user.id) {
        ...
        <div className="max-w-2xl mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Atualize as informações da vaga</CardDescription>
            </CardHeader>
            <CardContent>
